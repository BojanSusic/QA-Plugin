...
function front_qa_plugin()
{
        ...
        <table class="table table-striped table-borderless" id="table">
            ...
            <?php foreach ($data as $row): ?>
                ...
                <tr name="tableRow" id="row<?= $row->id ?>">
                    ...
                    <td><label for="<?= $row->id ?>"><?= $row->title ?></label></td>
                    <td><?= $row->description ?></td>
                    <td><textarea class="qa-comment" value="<?= $row->comment ?>" id="textArea<?= $row->id ?>"><?= $row->comment ?></textarea></td>
    ...
    <script src="/wp-content/plugins/qa-plugin/script.js"></script>
